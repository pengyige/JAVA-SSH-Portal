...
<html>
	...
	<body style="background-color:#FAA500;">
		<div class="mydiv1">
			...
			<p style="color: orange; text-align: center; font: '微软雅黑'; font-size: 28px;">亲爱的超级管理员您好，请登录</p>
		</div>
		<div class="mydiv2">
			 <div class="container">
        <div class="login-box">
            ...
            <!-- 登录/注册tab End -->
            <form name="myForm" id="myForm" action="user_superAdminLogin.action"  method="post" onsubmit="return clearCoookie();" style="display:block;"> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="email_autocomplete1">
                                    <input name="username" autocomplete="off" placeholder="手机号" nodetype="email" type="text" id="UserName" config="{width:267,height:40}" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
