						...
						<div class="content">
							...
							<div class="form loginBox">
								<form method="post" action="/login" accept-charset="UTF-8">
									<input id="username" class="form-control" type="text" placeholder="请输入手机号" name="email">
...
<script>
	/**系统管理员登入*/
	var TELEPORTER_ADMIN_LOGIN_URL = "${pageContext.request.contextPath}/teleporterAdmin_login.action";
	/**管理页*/
	var TELEPORTER_ADMIN_INDEX_URL = "${pageContext.request.contextPath}/teleporterAdmin_index.action";
	...
	function loginAjax(){
		...
		$.ajax({
			"url":TELEPORTER_ADMIN_LOGIN_URL,
			"type":"post",
			"dataType":"json",
			"data":requestParam,
			beforeSend:function (){
			...
			success:function (result){
				if ("200" != result.code){
					...
					//登入成功
					//调整到首页
					window.location.href = TELEPORTER_ADMIN_INDEX_URL;
				}
				console.log(result);
